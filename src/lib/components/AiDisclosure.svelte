...
<div class="mt-8 rounded border border-gray-200 bg-gray-50 px-4 py-3 text-xs leading-relaxed text-gray-400 print:bg-gray-50">
  <p>
    ...
    professional usage of AI.
    <a href="https://github.com/kaecyra/resume/issues/108" class="underline hover:text-gray-600">
      Here's the issue that created this message.
    </a>
  </p>
</div>
