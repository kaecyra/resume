...
To tailor a resume variant for a specific job posting, use the `customize-variant` skill at [.claude/skills/customize-variant/SKILL.md](./.claude/skills/customize-variant/SKILL.md).
